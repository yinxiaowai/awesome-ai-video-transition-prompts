...
- 25 example entries with prompts
- Local video assets under `assets/videos/`
- A playable browser gallery at `docs/index.html`
...
Curated by AI Yin Xiaowai, AIGC practitioner, AI trainer, and AI tools reviewer.
